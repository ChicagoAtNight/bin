...
DZEN_BG="#020202"
COLOR_SEP=$DZEN_FG2
FONT="-*-dejavu sans mono-medium-r-normal-*-11-*-*-*-*-*-*-*"
...
#clickable areas
VOL_MUTE_CMD="sh /home/aelman/bin/volman.sh mute"
VOL_UP_CMD="sh /home/aelman/bin/volman.sh up"
VOL_DOWN_CMD="sh /home/aelman/bin/volman.sh down"
